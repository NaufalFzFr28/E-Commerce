...
// Logika Bahasa (id, en, jp)
$lang = isset($_GET['lang']) ? $_GET['lang'] : 'id';

// Tentukan path file berdasarkan bahasa yang dipilih
$file_path = __DIR__ . "../../languages/{$lang}.json";

// Cek apakah file ada, jika tidak ada fallback ke Indonesia
if (file_exists($file_path)) {
    $json_content = file_get_contents($file_path);
    $text = json_decode($json_content, true);
} else {
    // Fallback manual jika file hilang
    $text = [
        "menu_home" => "Home",
        "back" => "Back"
    ];
...
if (file_exists($json_file)) {
    ...
    $json_data = file_get_contents("languages/id.json");
    $text = json_decode($json_data, true);
}
?>
    ...
    <section id="home" class="home-section">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                ...
                <p class="intro scramble-text"><?php echo $text['home_intro']; ?></p>
                <h1 class="name scramble-text"><?php echo $text['home_name']; ?></h1>
                <p class="desc scramble-text"><?php echo $text['home_desc']; ?></p>

                    <div class="btn-group-custom mt-4">
                        <a href="#" class="btn btn-primary custom-btn shadow-sm"><?php echo $text['btn_event_history']; ?></a>
                        <a href="#" class="btn btn-danger custom-btn shadow-sm"><?php echo $text['btn_watch_story']; ?></a>
                    </div>
                ...
                <div class="col-lg-6 col-md-8 text-center home-image d-none d-lg-block">
                    <!-- <img src="../../assets/imgs/man.png" alt="profile" class="img-fluid animate__animated animate__fadeInRight"> -->
                    <div class="swiper master-wpap-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="../../assets/imgs/man-1.png" alt="WPAP 1">
                            </div>
                            <div class="swiper-slide">
                                <img src="../../assets/imgs/man-2.png" alt="WPAP 2">
                            </div>
                            <div class="swiper-slide">
                                <img src="../../assets/imgs/man-3.png" alt="WPAP 3">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="stats-box shadow-lg border-0">
                <div id="triggerStats" class="text-center py-2">
                    <button class="btn btn-outline-danger rounded-pill px-4 fw-bold" onclick="startStatsAnimation()">
                        <i class="fas fa-chart-bar me-2"></i> <?php echo $text['stats_btn']; ?>
                    </button>
                </div>

                <div id="statsData" class="row text-center g-3 d-none reveal">
                    <div class="col-4">
                        <h3 class="text-danger fw-bold stat-number" data-target="675">0</h3>
                        <p class="mb-0 small stat-label"><?php echo $text['stats_subscribers']; ?></p>
                    </div>
                    <div class="col-4 border-start border-end">
                        <h3 class="text-warning fw-bold stat-number" data-target="796">0</h3>
                        <p class="mb-0 small stat-label"><?php echo $text['stats_followers']; ?></p>
                    </div>
                    <div class="col-4">
                        <h3 class="text-primary fw-bold stat-number" data-target="150">0</h3>
                    ...
                    <div class="flip-box reveal">
                        <div class="flip-box-inner">
                            <div class="flip-box-front">
                                <img src="../../assets/imgs/avatar-naufaru-1.jpg" alt="Naufal" class="img-thumbnail">
                            </div>
                            <div class="flip-box-back">
                                <img src="../../assets/imgs/avatar-naufaru-2.jpg" alt="Naufal" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="promo-content">
                ...
                <div class="images-group">
                    <div class="image-container">
                        <img src="../../assets/imgs/promo-1.jpg" alt="Promo 1">
                    </div>
                    <div class="image-container">
                        <img src="../../assets/imgs/promo-2.jpg" alt="Promo 2">
                    </div>
                </div>
                ...
                <div class="text-container">
                    ...
                    <a href="https://www.instagram.com/reel/DHOQBxKTPCr/" 
                    class="see-more-btn" 
                    target="_blank" 
    ...
    <section id="skills" class="section reveal">
        <div class="container-fluid" style="padding: 60px 10%;">
            ...
            <div class="row skills-wrapper text-left">
                <?php 
                $skills_data = [
                // Keahlian Penggunaan Software/Proses
                ['label' => 'skill_photo_edit', 'pct' => '95'],
                ['label' => 'skill_video_edit', 'pct' => '92'],
                ['label' => 'service_editor', 'pct' => '94'],
                
                // Keahlian Peran/Lapangan
                ['label' => 'service_photo', 'pct' => '93'],
                ['label' => 'service_video', 'pct' => '90'],
                ['label' => 'service_calligraphy', 'pct' => '90']
                ];
                
                foreach ($skills_data as $s) : ?>
                <div class="col-md-6 skill mb-4 reveal">
                    <p class="mb-2 fw-bold skill-label">
                        <?php echo isset($text[$s['label']]) ? $text[$s['label']] : $s['label']; ?>
                    </p>
                    <div class="skill-bar">
                        <div class="skill-percentage" data-percentage="<?php echo $s['pct']; ?>%"></div>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
